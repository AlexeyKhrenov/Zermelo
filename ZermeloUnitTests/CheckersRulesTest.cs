    ...
    public class CheckersRulesTest
    {
        ...
        public void CheckersRulesTest_1()
        {
            ...
            targetBoard.Player2.Figures.First(f => f.X == 3 && f.Y == 0).AvailableMoves =
                new List<Point>() { new Point(2, 1) };

            var move = new HistoryItem(sourceBoard.ActivePlayer, new Point(2, 3), new Point(3, 2));
        ...
        public void CheckersRulesTest_2()
        {
            ...
            targetBoard.SwitchPlayers();
            targetBoard.Player2.Figures.First(f => f.X == 3 && f.Y == 0).AvailableMoves =
                new List<Point>() { new Point(1, 2) };
            targetBoard.Player2.Figures.First(f => f.X == 1 && f.Y == 0).AvailableMoves =
                new List<Point>() { new Point(3, 2) };

            var move = new HistoryItem(sourceBoard.ActivePlayer, new Point(0, 3), new Point(2, 1));
        ...
        public void CheckersRulesTest_3()
        {
            ...
            var move = new HistoryItem(sourceBoard.ActivePlayer, new Point(3, 2), new Point(1, 0));
        ...
        public void CheckersRulesTest_4()
        {
            ...
            targetBoard.Player1.Figures.First(f => f.X == 1 && f.Y == 2).AvailableMoves =
                new List<Point>() { new Point(0, 3), new Point(0, 1), new Point(2, 1),};

            var move = new HistoryItem(sourceBoard.ActivePlayer, new Point(3, 2), new Point(2, 3));
        ...
        public void CheckersRulesTest_5()
        {
            ...
            targetBoard.Player1.Figures.First(f => f.X == 0 && f.Y == 2).AvailableMoves =
                new List<Point>() { new Point(2, 0) };

            var move = new HistoryItem(sourceBoard.ActivePlayer, new Point(2, 4), new Point(0, 2));
