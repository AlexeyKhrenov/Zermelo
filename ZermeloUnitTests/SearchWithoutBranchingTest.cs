...
namespace ZermeloUnitTests
{
    public class SearchWithoutBranchingTest
    {
        ...
        [InlineData("1", 1)]
        [InlineData("2 1", 2)]
        [InlineData("2 7 1 8", 2)]
        [InlineData("1 3 5 1 1 1 0 9", 3)]
        [InlineData("8 7 3 9 9 8 2 4 1 8 8 9 9 9 3 4", 8)]
        public void SearchWithoutBranchingTheory(string treeStr, byte expected)
        {
            var tree = TreeGenerator.ParseByteTree(treeStr, 2);
            var actual = _search.Search(tree, int.MaxValue);
